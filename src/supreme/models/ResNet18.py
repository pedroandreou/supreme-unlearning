...
Paper: "Deep Residual Learning for Image Recognition" (https://arxiv.org/abs/1512.03385v1)
...
class ResNet(nn.Module):
    def __init__(self, block, num_block, num_labels=100):
        super().__init__()
