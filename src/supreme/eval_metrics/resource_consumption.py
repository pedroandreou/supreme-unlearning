"""Resource Consumption evaluation metric (memory and GPU compute utilization).

Tracks resource consumption (memory and GPU compute utilization) incurred during
the unlearning process, gauging machine unlearning solutions' practical viability
and scalability.

Paper: "Learn to Unlearn: Insights Into Machine Unlearning" (https://www.computer.org/csdl/magazine/co/2024/03/10461690/1V5M1o68gKY)
