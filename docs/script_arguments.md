...
**Note:** Most users should use [run_local.sh](../src/supreme/run_local.sh) (documented in the README). This section is for advanced users running [train_main.py](../src/supreme/utils/training/train_main.py) or [unlearn_main.py](../src/supreme/utils/unlearning/unlearn_main.py) directly.

The two stages can be invoked three equivalent ways, all taking the same
arguments documented below:

- the scripts directly: `python src/supreme/utils/training/train_main.py ...`
...
Defined in [common_args.py](../src/supreme/utils/parsers/common_args.py):
...
## Training ([train_main.py](../src/supreme/utils/training/train_main.py))
...
## Unlearning ([unlearn_main.py](../src/supreme/utils/unlearning/unlearn_main.py))
