...
# Whereas same implementation is referred as either Layer-wise distance, Weight Distance or Layer-wise Weight Difference in
# Paper: "Fast Yet Effective Machine Unlearning" at https://arxiv.org/abs/2111.08947

"""
Paper: "DeltaGrad: Rapid retraining of machine learning models" at https://proceedings.mlr.press/v119/wu20b.html
and implementation can be found at: https://github.com/wuyinjun-1993/DeltaGrad/blob/ebb85816ba9ff6cd13dc88361886d4eae1bd7e77/src/utils.py#L447

Paper: "Forgetting Outside the Box: Scrubbing Deep Networks of Information Accessible from Input-Output Observations" at https://arxiv.org/abs/2003.02960
and implementation can be found at: https://github.com/AdityaGolatkar/SelectiveForgetting/blob/master/Forgetting.ipynb
