import torch
import random
from src.datasets.datasets import CombinedForgetRetainDataset
...
from src.utils.fabric.fabric_setup import setup_model_for_inference
...
# and implementation can be found at https://github.com/vikram2000b/bad-teaching-unlearning/


# https://github.com/vikram2000b/bad-teaching-unlearning/blob/f1aa988f71cccf1be6d50e0c6f7b2b905e4c9126/unlearn.py#L9
# and
# https://github.com/if-loops/selective-synaptic-dampening/blob/75fdea18497b0f5d654b136753a386fe74b9cd26/src/unlearn.py#L11
