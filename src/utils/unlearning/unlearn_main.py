...
from src.utils.generic_utils import set_seeds, initialize_network, dynamic_method_call
from src.utils.debug_utils import handle_distributed_error, create_debugger_session
from src.utils.unlearning.unlearning_utils import prepare_classwise_dataloaders
from src.utils.parsers.common_args import get_common_parser
import argparse
import os
from copy import deepcopy
from src.utils.model_logging import (
    save_model_and_logs,
    load_model_and_logs,
...
from src.utils.memory_utils import cleanup, cleanup_unlearning_checkpoint
from lightning.fabric import Fabric
from src.utils.process_tracker import ProcessTracker
from src.utils.fabric.callbacks import (
    # checkpoint_callback,
    TrainingCallback,
    TestCallback,
...
import signal
import sys
from src.utils.unlearning.evaluation_utils import track_resources
from src.utils.fabric.fabric_setup import initialize_fabric, convert_to_sync_batchnorm, setup_model_for_inference
from src.utils.wandb_utils.runtime.wandb_setup import initialize_wandb, check_wandb_run_exists
...
from src.eval_metrics.metrics_main import get_metric_scores
from src.utils.wandb_utils.runtime.wandb_setup import sync_wandb
from src.utils.generic_utils import strip_per_process_data
...
def setup_unlearning(
    ...
    if method_name in project_config.baselines:
        module_path = f"src.methods.baselines.{method_name}"
    elif method_name in project_config.unlearning_methods:
        module_path = f"src.methods.unlearning_methods.{method_name}"
    else:
